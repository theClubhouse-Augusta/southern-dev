window.onload = function () {
  ...
  */
  ...
  logo.addEventListener("mousemove", function(e) {
    logo.style.filter = "drop-shadow(" + Math.round((e.screenX - e.clientX) / 5) + "px " + Math.round((e.screenY - e.clientY) / 5) + "px 5px rgba(0, 0, 0, 0.5))";
    console.log(e.clientX, e.clientY);
    logo.style.filter = "-webkit-drop-shadow(" + Math.round((e.screenX - e.clientX) / 5) + "px " + Math.round((e.screenY - e.clientY) / 5) + "px 5px rgba(0, 0, 0, 0.5))";
    console.log(e.clientX, e.clientY);
  });
}